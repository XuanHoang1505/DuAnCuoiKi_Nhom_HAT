 ...
 * Use the {@link Date2Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Date2Fragment extends Fragment {
    ...
    public static Date2Fragment newInstance(String param1, String param2) {
        Date2Fragment fragment = new Date2Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mview = inflater.inflate(R.layout.fragment_date2, container, false);
        lv = mview.findViewById(R.id.lvgiochieu);
        
        lichChieuList = new ArrayList<>();
        lichChieuList.add(new lichchieu("Galaxy Nguyễn Du", Arrays.asList( "12:00", "14:00")));
        lichChieuList.add(new lichchieu("Galaxy Sala", Arrays.asList("11:00","15:00", "16:30")));
