 ...
 * Use the {@link ThirdDateFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ThirdDateFragment extends Fragment {
    private ListView lv;
     ...
     * @return A new instance of fragment ThirdDateFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ThirdDateFragment newInstance(String param1, String param2) {
        ThirdDateFragment fragment = new ThirdDateFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mview = inflater.inflate(R.layout.fragment_third_date, container, false);
        lv = mview.findViewById(R.id.lvMovie_3);

        listMovie = new ArrayList<>();
        listMovie.add(new Movie(R.drawable.image_item1, "Cám", "10/10/2024", 111, Arrays.asList("19:30","22:00", "22:30")));
        listMovie.add(new Movie(R.drawable.image_item18, "Bé trứng náo loạn châu Phi", "03/10/2024", 101, Arrays.asList("23:00", "23:30")));
