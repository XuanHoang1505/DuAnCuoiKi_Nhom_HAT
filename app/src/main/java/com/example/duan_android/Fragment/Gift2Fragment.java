 ...
 * Use the {@link Gift2Fragment#newInstance} factory method to
...
public class Gift2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        arrayList.add(new mygift(R.drawable.voucher1,"Voucher drink 10%",3));
        arrayList.add(new mygift(R.drawable.voucher2,"Voucher food 15%",2));
        arrayList.add(new mygift(R.drawable.voucher3,"Voucher 99k",1));
        adapterMyGift=new AdapterMyGift(getContext(),R.layout.layout_mygift,arrayList);
