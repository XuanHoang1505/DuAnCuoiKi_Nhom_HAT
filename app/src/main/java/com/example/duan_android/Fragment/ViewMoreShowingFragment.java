...
public class ViewMoreShowingFragment extends Fragment implements DataMovieAdapter.OnItemClickListener {
    ...
    private void getMovie() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Server.path_MovieViewMoreShowing, new Response.Listener<JSONArray>() {
            @Override
